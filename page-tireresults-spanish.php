 ...
 *
 * Template Name: Tire Results Spanish
 * @package WordPress
 * @subpackage wpcustom
*/
				...
				while ( have_posts() ) :
					...
					<div class="medium-6 large-6 small-12 columns">
						...
						<div class="printemailspecs text-center">
							<!--<button class="button js-addtoprint" type="button" data-id="<?php echo get_the_ID(); ?>" data-link="<?php the_permalink(); ?>">Imprimir/Email</button>-->
							<a href="<?php the_permalink(); ?>"><button class="button" type="button">Ver Especificaciones</button></a>
							<a href="<?php bloginfo( 'home' ); ?>/warranties">
								<button class="button" type="button">
									Garantías<?php if( $meta_warranty != '' ) echo ' <span class="warrantymileage">'. $meta_warranty . '</span>'; ?>
								</button>
							</a>
						</div>
					</div>
