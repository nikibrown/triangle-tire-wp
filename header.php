					...
					<div class="modal-inner">
						<div class="modal-content">
							...
							<form class="form-inline" action="<?php bloginfo('home'); ?>/" method="get">
								...
								<input class="form-control js-autocomplete-search" type="text" name="s" value="<?php if (!get_search_query()) : echo ''; else : echo get_search_query(); endif; ?>" onfocus="if (this.value == 'search') {this.value = '';}" onblur="if (this.value == '') {this.value = 'search';}" />
