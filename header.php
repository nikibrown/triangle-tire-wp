                            ...
                            <div class="modal-content">
                                ...
                                <form class="form-inline" action="<?php bloginfo('url'); ?>/" method="get">
                                    ...
                                    <input class="form-control js-autocomplete-search" type="text" name="s"
                                        value="<?php if (!get_search_query()) : echo ''; else : echo get_search_query(); endif; ?>"
        ...
        <div class="large-12 no-print">
            <div id="mainheaderrow" class="row">
                <div class="hideonmobile medium-12 large-3 columns">
                    <a class="logolink" href="<?php bloginfo( 'url' ); ?>"><img class="logo"
                            src="<?php bloginfo( 'template_url' ); ?>/images/Triangle_logo_tag-WHT.png"></a>
                </div>
                <div class="medium-12 large-9 columns">
                    <a class="hideondesktop logolink" href="<?php bloginfo( 'url' ); ?>"><img class="logo"
                            src="<?php bloginfo( 'template_url' ); ?>/images/Triangle_logo_tag-WHT.png"></a>
