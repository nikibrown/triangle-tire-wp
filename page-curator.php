    ...
    <div id="gearheads" class="row">
        <div class="medium-12 large-12 columns gearheadcontent">
            <div id="gearheadsinner" class="row scoopcolumns">
                <div class="large-12">
                    <div class="">
                        <section class="semantic-content reveal" id="modal-register" tabindex="-1" role="dialog"
                            aria-labelledby="modal-register" aria-hidden="true" data-reveal>
                            <div class="modal-inner">
                                <div class="modal-content">
                                    <a class="close-button" data-close aria-label="Close modal" type="button"><span
                                            ...
                                            <form
                                                ...
                                                <div id="mc_embed_signup_scroll">
                                                    ...
                                                    <div class="mc-field-group"><label for="mce-FNAME">First Name
                                                        </label><input type="text" name="FNAME" class=" text"
                                                            id="mce-FNAME" value=""></div>
                                                    <div class="mc-field-group"><label for="mce-LNAME">Last Name
                                                        </label><input type="text" name="LNAME" class=" text"
                        ...
                        <div class="row js-second-alert">
                            <div class="small-12 columns">
                                <div class="callout callout-instruction dark">
                                    <p class="text-center">
                                        Register here to receive weekly highlight emails on top OTR news.<br><a
                                            href="#modal-register" class="call-modal" title=""
                                            data-open="modal-register" aria-controls="modal-register"
                                            aria-haspopup="true" tabindex="0"><button class="button specialbutton"
