...
<div id="js-printblock">
    ...
    <div class="row">
        ...
        <div class="medium-5 large-3 columns emailprint no-print">
            <button class="button js-print" type="button" data-id="<?php echo get_the_ID(); ?>">Print</button> &nbsp;
            <button class="button js-email" type="button" data-id="<?php echo get_the_ID(); ?>">Email</button>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="large-12 footerlegend">
            <span class="primary">&#9679;</span> <span class="legend"> &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                primary notation</span><br>
            <span class="secondary">&#9679;</span> <span class="legend">
                &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp; secondary notation</span><br>
            <span class="third">&#9679;</span> <span class="legend"> &nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;
                third notation</span>
        </div>
    </div>
</div>
