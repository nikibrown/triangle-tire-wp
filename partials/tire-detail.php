...
<div class="js-printblock">
		...
		<div class="large-12">
			<?php
				if( get_post_type() == 'offroad_tires' ) {
					...
					echo '<img src=" https://triangletireus.com/wp-content/themes/triangle-new/images/PCR_banner-NEW.jpg">';
				}
			?>
		</div>
	</div>
	<div class="row">
		...
		<div class="medium-5 large-3 columns emailprint no-print">
			<button class="button js-init-batchprint" type="button" data-id="<?php echo $post_ID; ?>">Print</button> &nbsp; <a href="mailto:?subject=<?php echo sanitize_title( get_the_title( $post_ID ) ); ?>&body=<?php echo urlencode(get_the_permalink( $post_ID )) ?>" class="button" target="_top" data-id="<?php echo $post_ID; ?>">Email</a>
